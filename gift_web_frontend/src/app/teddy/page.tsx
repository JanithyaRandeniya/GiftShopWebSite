...
const teddies = [
  { id:1, name:"Classic Cream Teddy Bear", price:1900, badge:"", img:"/images/gifts/teddy1.webp", hoverImg:"/images/gifts/mensgift1.webp", desc:"Extra-soft 30cm plush teddy, perfect for gifting", size:"30cm", rating:4, reviews:47 },
  { id:2, name:"Giant Cuddle Bear XL", price:4500, badge:"Popular", img:"/images/gifts/teddy1.webp", hoverImg:"/images/gifts/wallet1.webp", desc:"1.2m ultra-soft plush bear — the ultimate hug", size:"120cm", rating:5, reviews:113 },
  { id:3, name:"Heart Teddy with Message", price:2400, badge:"Romantic", img:"/images/gifts/boxwithflower1.jpg", hoverImg:"/images/gifts/teddy1.webp", desc:"Holds a satin heart with your personalised message", size:"40cm", rating:5, reviews:89 },
  { id:4, name:"Rainbow Panda Plush", price:2200, badge:"New", img:"/images/gifts/mensgift1.webp", hoverImg:"/images/gifts/teddy1.webp", desc:"Colourful panda plush, great for kids & adults", size:"35cm", rating:4, reviews:31 },
  { id:5, name:"Luxury Bunny Plush Set", price:3100, badge:"", img:"/images/gifts/photoframe1.webp", hoverImg:"/images/gifts/boxwithflower1.jpg", desc:"Velvet-soft bunny with bow ribbon in gift box", size:"45cm", rating:5, reviews:55 },
  { id:6, name:"Teddy Bear Gift Bundle", price:5200, badge:"Bundle Deal", img:"/images/gifts/black_box.jpg", hoverImg:"/images/gifts/choco1.webp", desc:"30cm teddy + chocolate box + greeting card", size:"30cm", rating:5, reviews:74 },
];
...
const styles = `
  ...
  /* HERO */
  .teddy-hero {
    background: linear-gradient(160deg, #fff0e8 0%, #fde8ef 40%, #f5f0ff 100%);
    padding: 72px 48px 56px; position: relative; overflow: hidden;
  }
  .teddy-hero::before {
    content: '🧸'; position: absolute; right: 60px; bottom: -20px;
    font-size: 220px; opacity: 0.07; pointer-events: none;
  ...
  .teddy-hero h1 {
    ...
    color: #4a2040; margin-bottom: 12px; line-height: 1.1;
  }
  ...
  .teddy-badge {
    background: white; border: 1.5px solid rgba(232,84,122,0.15);
    border-radius: 50px; padding: 8px 18px;
    font-size: 0.82rem; font-weight: 600; color: #4a2040;
    box-shadow: 0 2px 8px rgba(232,84,122,0.08);
  }
  ...
  /* CARD — warm tilt + cross-fade image */
  .tc-card {
    background: white; border-radius: 24px; overflow: hidden;
    box-shadow: 0 6px 24px rgba(74,32,64,0.08);
    border: 1px solid rgba(232,84,122,0.07);
  ...
  .tc-card:hover {
    ...
    box-shadow: 0 20px 48px rgba(232,84,122,0.2);
  }
  ...
  .tc-badge {
    ...
    background: linear-gradient(135deg, #e8547a, #7b3f8c);
  }
  .wishlist-btn {
  ...
  .tc-size {
    display: inline-block; background: linear-gradient(135deg, #fff0e8, #fde8ef);
    color: #8a5040; font-size: 0.72rem; font-weight: 700;
  ...
  .tc-cart {
    background: linear-gradient(135deg, #4a2040, #e8547a);
  ...
  .teddy-cta {
    text-align: center;
    background: linear-gradient(135deg, #fff0e8 0%, #fde8ef 50%, #f5e8ff 100%);
    border-radius: 28px; padding: 60px 40px; margin-top: 64px;
    border: 2px solid rgba(232,84,122,0.1);
    position: relative; overflow: hidden;
  }
  .teddy-cta::before {
    content: ''; position: absolute; inset: 0;
    background: radial-gradient(circle at 70% 50%, rgba(232,84,122,0.05) 0%, transparent 60%);
    pointer-events: none;
  }
  ...
  .g-toast {
    ...
    box-shadow: 0 8px 24px rgba(74,32,64,0.3); z-index: 9999;
    animation: toastIn 0.3s ease;
  }
  @keyframes toastIn { from { opacity:0; transform: translateX(-50%) translateY(10px); } to { opacity:1; transform: translateX(-50%) translateY(0); } }

  @media(max-width:768px) {
    .teddy-hero, .g-section { padding: 48px 20px; }
  }
`;
              ...
              <div key={t.id} className="tc-card">
                ...
                <div className="tc-info">
                  ...
                  <div className="tc-footer">
                    ...
                    <button className="tc-cart" onClick={() => showToast(`🧸 Added to cart!`)}>Add to Cart</button>
                  </div>
                </div>
              </div>
            ))}
