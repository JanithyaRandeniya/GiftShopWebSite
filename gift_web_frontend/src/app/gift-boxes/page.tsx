...
const giftBoxes = [
  { id:201, name:"Luxury Pink Celebration Box",    price:4500, badge:"Bestseller", img:"/images/gifts/boxwithflower1.jpg", hoverImg:"/images/gifts/black_box.jpg",      emoji:"🎁", desc:"Satin-lined box with ribbon bow, chocolates, mini candle & handwritten card", rating:5, reviews:128, occasion:"Birthday"    },
  { id:202, name:"Premium Love Anniversary Box",   price:5500, badge:"Limited",    img:"/images/gifts/black_box.jpg",       hoverImg:"/images/gifts/boxwithflower1.jpg", emoji:"💝", desc:"Rose petals, chocolate truffles, mini perfume & memory journal",             rating:5, reviews:201, occasion:"Anniversary" },
  { id:203, name:"Birthday Surprise Mega Box",     price:3800, badge:"Popular",    img:"/images/gifts/boxwithflower1.jpg", hoverImg:"/images/gifts/choco1.webp",        emoji:"🎂", desc:"Personalized with name, includes 3 chocolates, balloon & card",             rating:5, reviews:156, occasion:"Birthday"    },
  ...
  { id:205, name:"New Baby Welcome Box",           price:4200, badge:"New",        img:"/images/gifts/boxwithflower1.jpg", hoverImg:"/images/gifts/teddy1.webp",        emoji:"👶", desc:"Soft toy, baby keepsake card, sweet treats & pastel wrapping",               rating:4, reviews:44,  occasion:"New Baby"    },
  ...
  { id:207, name:"Wedding Favour Box (Set of 10)", price:8500, badge:"Bulk Deal",  img:"/images/gifts/boxwithflower1.jpg", hoverImg:"/images/gifts/black_box.jpg",      emoji:"💒", desc:"10 mini boxes, personalized tags, each filled with 4 chocolates",           rating:5, reviews:32,  occasion:"Wedding"     },
