...
const giftBoxes = [
  { id:1, name:"Luxury Pink Celebration Box", price:4500, badge:"Bestseller", img:"/images/gifts/boxwithflower1.jpg", hoverImg:"/images/gifts/black_box.jpg", desc:"Satin-lined box with ribbon bow, chocolates, mini candle & handwritten card", rating:5, reviews:128, occasion:"Birthday" },
  { id:2, name:"Premium Love Anniversary Box", price:5500, badge:"Limited", img:"/images/gifts/black_box.jpg", hoverImg:"/images/gifts/boxwithflower1.jpg", desc:"Rose petals, chocolate truffles, mini perfume & memory journal", rating:5, reviews:201, occasion:"Anniversary" },
  { id:3, name:"Birthday Surprise Mega Box", price:3800, badge:"Popular", img:"/images/gifts/boxwithflower1.jpg", hoverImg:"/images/gifts/choco1.webp", desc:"Personalized with name, includes 3 chocolates, balloon & card", rating:5, reviews:156, occasion:"Birthday" },
  { id:4, name:"Anniversary Keepsake Premium", price:6200, badge:"Premium", img:"/images/gifts/black_box.jpg", hoverImg:"/images/gifts/wallet1.webp", desc:"Gold-foil box, luxury chocolates, scented candle & custom message locket", rating:5, reviews:89, occasion:"Anniversary" },
  { id:5, name:"New Baby Welcome Box", price:4200, badge:"New", img:"/images/gifts/boxwithflower1.jpg", hoverImg:"/images/gifts/teddy1.webp", desc:"Soft toy, baby keepsake card, sweet treats & pastel wrapping", rating:4, reviews:44, occasion:"New Baby" },
  { id:6, name:"Thank You Gratitude Box", price:2900, badge:"", img:"/images/gifts/black_box.jpg", hoverImg:"/images/gifts/choco1.webp", desc:"Gourmet cookies, tea selection & heartfelt card", rating:4, reviews:67, occasion:"Thank You" },
  { id:7, name:"Wedding Favour Box (Set of 10)", price:8500, badge:"Bulk Deal", img:"/images/gifts/boxwithflower1.jpg", hoverImg:"/images/gifts/black_box.jpg", desc:"10 mini boxes, personalized tags, each filled with 4 chocolates", rating:5, reviews:32, occasion:"Wedding" },
  { id:8, name:"Festive Celebration Hamper", price:7200, badge:"Seasonal", img:"/images/gifts/black_box.jpg", hoverImg:"/images/gifts/boxwithflower1.jpg", desc:"Deluxe hamper with premium sweets, dry fruits & decorative tray", rating:5, reviews:78, occasion:"Festival" },
];
...
const styles = `
  ...
  /* HERO */
  .boxes-hero {
    background: linear-gradient(135deg, #fdf0e8 0%, #fde8ef 50%, #f5f0e0 100%);
    padding: 72px 48px 56px; position: relative; overflow: hidden;
  }
  .boxes-hero::before {
    content: '🎁'; position: absolute; right: 80px; bottom: -30px;
    font-size: 240px; opacity: 0.06; transform: rotate(-8deg); pointer-events: none;
  }
  ...
  .boxes-hero h1 {
    ...
    color: #3d2010; margin-bottom: 12px; line-height: 1.1;
  }
  ...
  .box-hero-card {
    ...
    border: 1px solid rgba(200,120,64,0.15); min-width: 110px;
  }
  ...
  .occ-btn {
    ...
    border: 1.5px solid rgba(200,120,64,0.2);
    background: white; font-family: 'Jost', sans-serif; font-weight: 500;
    font-size: 0.83rem; cursor: pointer; transition: all 0.2s; color: #7a5a3a;
  }
  .occ-btn:hover { border-color: #c87840; color: #c87840; transform: translateY(-1px); }
  .occ-btn.active {
    background: linear-gradient(135deg, #c87840, #3d2010);
    color: white; border-color: transparent;
    box-shadow: 0 4px 16px rgba(200,120,64,0.3);
  }
  ...
  /* CARD — zoom lens effect */
  .bc-card {
    background: white; border-radius: 22px; overflow: hidden;
    box-shadow: 0 4px 20px rgba(61,32,16,0.08);
  ...
  .bc-card:hover {
    ...
    box-shadow: 0 20px 48px rgba(200,120,64,0.2);
  }

  .bc-img-wrap {
    position: relative; height: 230px; overflow: hidden;
    background: linear-gradient(135deg, #fdf0e8, #fde8ef);
    cursor: zoom-in;
  }
  .bc-img-main {
  ...
  .bc-img-wrap::after {
    content: '';
    position: absolute; inset: 0;
    background: linear-gradient(105deg, transparent 30%, rgba(255,220,120,0.18) 50%, transparent 70%);
  ...
  .bc-badge {
    ...
    background: linear-gradient(135deg, #c87840, #8a5020);
  }
  .wishlist-btn {
  ...
  .bc-occasion {
    display: inline-block; background: rgba(200,120,64,0.08); color: #8a5020;
  ...
  .bc-cart {
    background: linear-gradient(135deg, #3d2010, #c87840);
    color: white; border: none; padding: 9px 18px; border-radius: 50px;
    font-family: 'Jost', sans-serif; font-weight: 600; font-size: 0.8rem;
  ...
  /* CTA */
  .box-cta {
    background: linear-gradient(135deg, #3d2010 0%, #c87840 100%);
    border-radius: 28px; padding: 64px 48px; text-align: center; color: white; margin-top: 80px;
    position: relative; overflow: hidden;
  }
  .box-cta::before {
    content: '✨'; position: absolute; right: 60px; top: 50%;
    transform: translateY(-50%); font-size: 160px; opacity: 0.06; pointer-events: none;
  }
  ...
  .g-toast {
    ...
    box-shadow: 0 8px 24px rgba(61,32,16,0.3); z-index: 9999;
    animation: toastIn 0.3s ease;
  }
  @keyframes toastIn { from { opacity:0; transform: translateX(-50%) translateY(10px); } to { opacity:1; transform: translateX(-50%) translateY(0); } }

  @media(max-width:768px) {
    .boxes-hero, .g-section { padding: 48px 20px; }
    .box-cta { padding: 48px 24px; }
  }
`;
              ...
              <div key={box.id} className="bc-card">
                ...
                <div className="bc-info">
                  ...
                  <div className="bc-footer">
                    ...
                    <button className="bc-cart" onClick={() => showToast(`🎁 Added to cart!`)}>Add to Cart</button>
                  </div>
                </div>
              </div>
            ))}
